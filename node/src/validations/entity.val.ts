...
export const EntitySchema = intersect([
    NameSchema(128),
    required(
        object({
            id_entity_type: pipe(
            ...
            address: nullish(
                pipe(
                    ...
                    maxLength(
                        128,
                        "La dirección no debe exceder 128 carácteres"
                    )
                ),
                null
            ),
            domicile: nullish(
                pipe(
                    ...
                    maxLength(
                        128,
                        "El domicilio no debe exceder 128 carácteres"
                    )
                ),
                null
            ),
            ...
            phone: nullish(
                union([
                    pipe(
                        ...
                        length(
                            10,
                            "El teléfono debe ser de exactamente 10 dígitos"
                        )
                    ),
                    pipe(
